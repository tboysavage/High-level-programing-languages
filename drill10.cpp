...
void print_vector(const vector<Point>& points)//<<< question 2
{
...
int main()
try {
    vector<Point> original_points;//<<<<<<<< question 2
    ...
    // print points//<<<<<<<< question 3
    cout << "\nOriginal points:\n";
    print_vector(original_points);

    // write points to file//<<<<<<<< question 4
    string filename = "mydata.txt";
    write_to_file(original_points,filename);

    // read points from file////<<<<<< question 5
    vector<Point> processed_points;
    fill_from_file(processed_points,filename);

    // print data from both vectors//<<<<<< question 6
    cout << "\nData from ifstream:\n";
    print_vector(processed_points);
    cout << "\nOriginal data:\n";
    print_vector(original_points);

    // compare vectors//<<<<<<<< question 7
